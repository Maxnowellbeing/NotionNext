...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Maxnowell', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '通信狗', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.298311.xyz/', // 网站地址
